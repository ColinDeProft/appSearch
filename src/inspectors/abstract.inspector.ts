...
export abstract class Inspector {
    ...
    usedCriteria: {[criterionName: string]: string} = {} // == what given criteria are used
    ...
    setupInspector(criteriaList: {[criterionName: string]: string}): void { // fill usedCriteria & unavailableCriteria
